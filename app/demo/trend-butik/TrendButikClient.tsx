    ...
    <DemoShell>
      <div className="relative bg-ink text-paper">
        <section className="grain relative overflow-hidden border-b border-ink-line px-6 py-24 text-center">
          <div
            className="cinematic-in mx-auto flex h-28 w-28 items-center justify-center rounded-2xl bg-gradient-to-br from-rose-950 to-rose-800 text-white shadow-lg"
            ...
            {visibleProducts.map((p) => (
              ...
              >
                <div className="relative aspect-square overflow-hidden bg-ink">
                  ...
                  />
                  <span className="absolute inset-x-3 bottom-3 rounded-md bg-paper/80 py-2 text-center text-xs font-semibold text-ink opacity-0 backdrop-blur transition-opacity group-hover:opacity-100">
                    Sürətli baxış
                  </span>
                </div>
                <div className="p-3">
